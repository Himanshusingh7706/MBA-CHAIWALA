        ...
        <>
            <footer>
                ...
                <aside onMouseLeave={linkBackToNormal}>
                    ...
                    <a href="/chawalacares" className="footerLinks" onMouseOver={() => { footerLinks(5) }} data-cursorpointermini={true}> Chai Wala Cares</a>
                </aside>
                <div>
                    ...
                    <a href="mailto:franchis@mbachaiwala.com"> Franchis@mbachaiwala.com</a>
                </div>
                <div>
                    <a href="tel:+91722905222">  Phone +91722905222  </a>
                </div>
